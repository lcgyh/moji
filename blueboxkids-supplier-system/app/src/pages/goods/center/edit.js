...
class BasicForms extends Component {
  ...
  columns = [
    ...
    },
    {
      ...
      width: '20%',
      render: (text, record, index) => (
        <Input value={text} onChange={this.hindBarcode.bind(this, index)} />
      ),
    },
    ...
    },
    {
      ...
      width: '10%',
      render: (text, record, index) => (
        <a onClick={this.hindDelete.bind(this, record, index)}>
          <FormattedMessage id="publickey.delete" />
        </a>
      ),
    },
  ];
  ...
  handleSubmit = () => {
    ...
    form.validateFieldsAndScroll(async (err, values) => {
      if (!err) {
        ...
        console.log('goodsSkusouce', goodsSkusouce);
        ...
        <Card bordered={false}>
          ...
          >
            ...
            <FormItem>
              <Row>
                ...
                <Col span={24}>
                    ...
                    title={() => (
                      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                        ...
                        <span onClick={() => this.handaddSku()}>
                          {' '}
                          <a>
                            <FormattedMessage id="publickey.addSku" />
                          </a>
                        </span>
                      </div>
                      ...
                      // <span onClick={() => this.handaddSku()}>
                      //   {' '}
                      //   <a><FormattedMessage id="publickey.addSku" /></a>
                      // </span>
                    )}
                    bordered
                  ...
                  <div>
                    {/* 批量设置： */}
                    <FormattedMessage id="publickey.BatchOperation" />:
                    {this.state.focus1 ? (
                      ...
                      >
                        ...
                        {/* 品牌供货价 */}
                        {/* supplyPrice */}
                        <FormattedMessage id="publickey.supplyPrice" />
                      </span>
                    )}
                    {this.state.focus2 ? (
                      <span style={{ marginRight: '20px' }}>
                      ...
                      >
                        ...
                        {/* 店主供货价 */}
                        {/* retailPrice */}
                        <FormattedMessage id="publickey.retailPrice" />
                      </span>
                    )}
                    {this.state.focus3 ? (
                      <span style={{ marginRight: '20px' }}>
                      ...
                      >
                        ...
                        {/* 建议零售价 */}
                        {/* suggestedPrice */}
                        <FormattedMessage id="publickey.suggestedPrice" />
                      </span>
                    )}
                  </div>
                </Col>
              ...
              <Row>
                {/* <Col span={7}>
                  <Button type="dashed" onClick={this.hindText.bind(this)}>
                    <Icon type="plus" /> <FormattedMessage id="publickey.addText" />
                  </Button>
                </Col> */}
                <Col span={14}>
                  <Button type="dashed" onClick={this.hindPic.bind(this)}>
                    <Icon type="plus" /> <FormattedMessage id="publickey.addImg" />
                  </Button>
                </Col>
              </Row>
                ...
                (item.type == '1' ? (
                  <Row key={index}>
                    ...
                    <Col span={7} style={{ textAlign: 'right' }}>
                      <a onClick={this.hindInfoList.bind(this, index)}>
                        <FormattedMessage id="publickey.delete" />
                      </a>
                    </Col>
                  </Row>
            ...
            >
              ...
              >
                <FormattedMessage id="publickey.submit" />
              </Button>
            </FormItem>
          </Form>
        </Card>
